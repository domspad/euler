...
# 63 mins, BUT not proven true...brute force
	# to prove true and check all possibilities would be roughly product({20, 31, 38, 39, 40, 42, 45}) == 69,464,304,000 iters
		# which is 3ms in worse case for each check --> 6.6 years :(
...
# assert is_special_subset(set((2,3,4))) == True	#TRUE
# assert is_special_subset(set((1,3,10))) == False  #FALSE


# brute

n = 7
# want to minimize S(A) for all sets A with n=7 positive ints

# #check upperbound? 
# sols = [{1}, {1,2}, {2,3,4}, {3,5,6,7}, {6,9,11,12,13}, {11, 18, 19, 20, 22, 25}]
# seven = {20, 31, 38, 39, 40, 42, 45} # CONFIRMED UPPER BOUND!

# from timeit import timeit
# for sol in sols:
# 	print sol, is_special_subset(sol)
